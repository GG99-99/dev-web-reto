...
export type PasswordResetTokenWhereInput = {
  ...
  tokenId?: Prisma.IntFilter<"PasswordResetToken"> | number
...
export type PasswordResetTokenScalarWhereWithAggregatesInput = {
  ...
  tokenId?: Prisma.IntWithAggregatesFilter<"PasswordResetToken"> | number
...
export type PasswordResetTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"tokenId" | "userId" | "token" | "expiresAt" | "used" | "createdAt", ExtArgs["result"]["passwordResetToken"]>
...
export interface PasswordResetTokenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const passwordResetTokenWithTokenIdOnly = await prisma.passwordResetToken.findMany({ select: { tokenId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many PasswordResetTokens and only return the `tokenId`
   * const passwordResetTokenWithTokenIdOnly = await prisma.passwordResetToken.createManyAndReturn({
   *   select: { tokenId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more PasswordResetTokens and only return the `tokenId`
   * const passwordResetTokenWithTokenIdOnly = await prisma.passwordResetToken.updateManyAndReturn({
   *   select: { tokenId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PasswordResetTokenFieldRefs {
  readonly tokenId: Prisma.FieldRef<"PasswordResetToken", 'Int'>
